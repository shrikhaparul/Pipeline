...
def read(json_data: dict, delimiter = ",",skip_header = 0, skip_footer= 0, quotechar = '"', escapechar = None) -> bool:
    ...
    try:
        ...
        default_encoding = "unicode_escape" if json_data["task"]["source"]["encoding"]==" " else\
